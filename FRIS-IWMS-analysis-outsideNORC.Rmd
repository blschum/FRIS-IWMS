...
find <- find %>% 
  mutate(
    category = case_when(
      category == "K215" ~ "K0215 - USDA water conservation (tech.)",
      category == "K216" ~ "K0216 - USDA water conservation (fin.)",
      category == "K217" ~ "K0217 - USDA stewardship/easements (tech.)",
      category == "K218" ~ "K0218 - USDA stewardship/easements (fin.)",
      category == "K219" ~ "K0219 - Non-USDA federal programs (tech.)",
      category == "K235" ~ "K0235 - Non-USDA federal programs (fin.)",
      category == "K236" ~ "K0236 - State & local water programs (tech.)",
      category == "K237" ~ "K0237 - State & local water programs (fin.)",
      category == "K238" ~ "K0238 - Private dealers & lenders (tech.)",
      category == "K239" ~ "K0239 - Private dealers & lenders (fin.)"
    )
  )
