...
# 2013 - 2018 (- = less water applied in 2013, + = more water applied in 2013)
diff_drought <- y %>% 
    #filter(CROP == "ALFALFA") %>% 
    ...
    select(GEOID,CROP,yield_diff_KG,wa_diff_M,ip_diff_KGM)
...
barrier_map <- tm_shape(ctys) + tm_polygons(col="grey", border.col = "white") +
  tm_shape(barrier_sp) + 
    tm_polygons("Barrier to Implementation", palette = c("#66C2A5", "#FC8D62", "#8DA0CB", "#E78AC3", "#A6D854", "#FFD92F", "#E5C494", "#696969", "#2F2F2F"),
 border.col = "white")  +
